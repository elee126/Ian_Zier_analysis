...
zier_ridge_og <- ridge_tbl %>% 
  ggplot(aes(x = value, y = key, fill = ..x..)) + 
  geom_density_ridges_gradient(bandwidth = 3, color = "white", quantile_lines = TRUE, quantiles = 2, scale = 2, vline_size = 1.25, vline_color = "black") + 
...
zier_ridge <- ridge_tbl %>% 
  ...
  geom_density_ridges_gradient(bandwidth = 3, scale = 2, color = "white", 
   ...
   scale_discrete_manual("vline_color", 
                        values = c("black", "red", "black", "white"), guide = "none") + 
